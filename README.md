...
The actual amount sent from the vault to the recipient is `max_topup_amount - current_recipient_balance`. 
...
Plus, if you can link a wallet to a participant, using their wallet address, where they got SOL from the faucet
you could then check engagement and maybe(?) add a leaderboard! 
